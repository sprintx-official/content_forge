  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        {item.workflowName && (
          <span className="text-xs font-medium px-2.5 py-0.5 rounded-full bg-[#6366f1]/20 text-[#6366f1]">
            {item.workflowName}
          </span>
        )}
      ...
      {/* Generated by */}
      {item.userName && (
        <p className="inline-flex items-center gap-1 text-xs text-[#cbd5e1] mb-3">
