  ...
  return (
    <>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        {isGenerating && (
          <div className="aspect-square rounded-xl bg-gradient-to-br from-[#10b981]/5 to-[#6366f1]/5 border border-white/[0.08] animate-pulse flex items-center justify-center">
